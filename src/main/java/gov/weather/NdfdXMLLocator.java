...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements gov.weather.NdfdXML {
 ...
 */
    ...
    public gov.weather.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public gov.weather.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.weather.NdfdXMLBindingStub _stub = new gov.weather.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.weather.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.weather.NdfdXMLBindingStub _stub = new gov.weather.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://graphical.weather.gov/xml/DWMLgen/wsdl/ndfdXML.wsdl", "ndfdXML");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://graphical.weather.gov/xml/DWMLgen/wsdl/ndfdXML.wsdl", "ndfdXMLPort"));
        }
